...
**Важно:**
Python *не работает с абстрактными файлами*. Он всегда работает с файлами, которые находятся **в конкретном месте файловой системы**.
...
```json
[{"name": "Ivan", "average": 4.2}, {"name": "Maria", "average": 4.8}]
```
