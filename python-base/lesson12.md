...
3. На вход программе подается строка из слов через запятую и пробел. Создайте список из входящей строки. Удалите последний элемент списка. Выведите на экран получившейся список и удаленный элемент.
