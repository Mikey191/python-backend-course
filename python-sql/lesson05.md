...
*Эта задача должна быть раделена на два шага: сначала найти пользователей с двумя и более заказами, затем для них посчитать разбивку по статусам. Чистое решение требует `подзапроса` (Урок 7).*
